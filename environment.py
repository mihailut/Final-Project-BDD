...
# de fiecare data cand adaugam o pagina noua in proiect ,ea va trebui adaugat si in context
# before_all = nume de metoda standardizat care da sistemului informatii ca acele instructiuni
# trebuie executate inainte de executarea unui scenariu
